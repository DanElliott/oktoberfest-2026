# Oktoberfest 2026: The Crew's Guide to the Wiesn
Three days, four friends, three tents, and a lot of Maß. Everything you need to know before we land in Munich — who's coming, where we're sleeping, what tents we're storming, and how not to embarrass ourselves in front of the locals.

<!--
EDITING THIS FILE
=================
This whole site is generated from this one Markdown file. Structure rules the
build script relies on:
  - "## " starts a new top-level section (shown as a nav item).
  - "### " starts a card/subsection within that section (a guest, a tent, a
    tip category, etc.) — its title becomes the card heading.
  - Everything else is normal Markdown (bold, links, lists, paragraphs) and
    is rendered as-is, so feel free to rewrite freely.
  - Anything marked [PLACEHOLDER] is mock data — swap it for the real thing
    whenever it's confirmed (photos, times, names, addresses).
  - Photos: drop image files into assets/images/ and reference them with
    a normal Markdown image, e.g. ![Alt text](images/your-photo.jpg)
-->
...
**Atmosphere.** Traditional Bavarian brass bands, a lot of communal sing-alongs, and a genuinely festive, welcoming crowd — this tent is also famous for its "Gay Sunday" afternoon, one of the warmest and most inclusive parties on the Wiesn. Expect wood-carved interiors, a big dance floor energy once the band gets going, and a slightly older, more local mix than some of the rowdier tents.
...
**Atmosphere.** This is the loudest, highest-energy tent on our list. Expect people standing (and dancing) on the benches, a brass band alternating oompah classics with crowd-pleasing pop and rock, and a party crowd that skews young and international. Great fun, but arrive on time — it fills up fast and gets very loud very quickly.
...
**Atmosphere.** Noticeably calmer and more local than Bräurosl or Hofbräu — a warm, rustic wooden interior, traditional Bavarian music rather than pop covers, and a crowd that's there for good beer and good fish rather than to climb on the tables. A nice way to close out the trip on a mellower note.
...
**Getting oriented.** Theresienwiese is split roughly into a north side (Hofbräu-Festzelt, Hacker-Festzelt, Löwenbräu) and south side (Bräurosl, Fischer-Vroni, Schottenhamel) — worth knowing which entrance to head for so you're not crossing the entire festival with three days of blisters already forming.

## Know Before You Go

### Getting In & Security
- Bag checks and metal detectors are standard at every entrance — arrive a little early on busy evenings.
...
- Common practice: round up generously, roughly **5–10%** of the bill, handed directly to your server as you pay (not left on the table).
- Say the total you want to pay out loud as you hand over cash (e.g. bill is €38, you hand €40 and say "forty" / "stimmt so") rather than waiting for change and leaving a separate tip.
- Servers are running enormous sections carrying full trays of Maß — a good tip for good service goes a long way and is genuinely earned.

### Attire
- Trachten (traditional dress) isn't required, but the vast majority of the tent crowd wears it, and it's part of the fun — Lederhosen for some of us, Dirndl for others, or just come as you are.
